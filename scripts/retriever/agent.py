...
教授研究與個人資訊排版規範：
- 必須以教授姓名為首：每個教授的資訊必須以姓名作為標題開頭（例如：1. [教授姓名]）。
- 研究內容在姓名下方：在姓名下方，具體分點說明其研究領域、重點實驗室、以及近期代表性成果；嚴禁將不同教授的資訊混雜在同一段落。
- 總體分析：若檢索集包含摘要，請分析並總結其核心研究方向與近年突破，避免單純條列論文題目。
- 結構分明：不同教授之間、不同資訊塊之間請保持空行，確保排版有條理。
